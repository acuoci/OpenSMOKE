...
void OpenSMOKE_CharKineticScheme::UpdateKineticParameters(const int iModel, solid_regression_parameters &parameters, BzzVector &b, BzzMatrixInt &user)
{
	int j;
...
void OpenSMOKE_CharKineticScheme::UpdateOptimizerParameters(const int iModel, solid_regression_parameters &parameters, BzzVector &b, BzzMatrixInt &user)
{
	int j;
