...
enum OpenSMOKE_SolidExperiment_Char_Experimental_Data {Char_CONVERSION_CHAR, Char_D_CONVERSION_CHAR, Char_MASS_RATIO, Char_D_MASS_RATIO};
...
public:
	...
	OpenSMOKE_SolidExperiment_Char_Experimental_Data	kind_of_experimental_data;
