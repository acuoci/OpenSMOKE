...
public:
	...
	void SetMinimumDelta_PHI(const double _value);
	void SetMaximumDelta_PHI(const double _value);
...
private:
	...
	double minimum_ratio_PHI;
	double maximum_ratio_PHI;
};
