...
#if !defined(OPENSMOKE_LIQUIDVAPORPRESSURE_DICTIONARY_H)
#define OPENSMOKE_LIQUIDVAPORPRESSURE_DICTIONARY_H

#include "OpenSMOKE.hpp"

class OpenSMOKE_LiquidVaporPressure_Dictionary
{
...
public:
	...
	OpenSMOKE_LiquidVaporPressure_Dictionary();
...
private:
	...
	vector<liquid_vaporpressure_equation::equation> equation;
...
#endif // OPENSMOKE_LIQUIDVAPORPRESSURE_DICTIONARY_H
