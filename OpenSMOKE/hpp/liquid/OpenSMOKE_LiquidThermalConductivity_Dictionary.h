...
#if !defined(OPENSMOKE_LIQUIDTHERMALCONDUCTIVITY_DICTIONARY_H)
#define OPENSMOKE_LIQUIDTHERMALCONDUCTIVITY_DICTIONARY_H

#include "OpenSMOKE.hpp"

class OpenSMOKE_LiquidThermalConductivity_Dictionary
{
...
public:
	...
	OpenSMOKE_LiquidThermalConductivity_Dictionary();
...
private:
	...
	vector<liquid_thermalconductivity_equation::equation> equation;
...
#endif // OPENSMOKE_LIQUIDTHERMALCONDUCTIVITY_DICTIONARY_H