...
#if !defined(OPENSMOKE_LIQUIDVAPORIZATIONHEAT_DICTIONARY_H)
#define OPENSMOKE_LIQUIDVAPORIZATIONHEAT_DICTIONARY_H

#include "OpenSMOKE.hpp"

class OpenSMOKE_LiquidVaporizationHeat_Dictionary
{
...
public:
	...
	OpenSMOKE_LiquidVaporizationHeat_Dictionary();
...
private:
	...
	vector<liquid_vaporizationheat_equation::equation> equation;
...
#endif // OPENSMOKE_LIQUIDVAPORIZATIONHEAT_DICTIONARY_H