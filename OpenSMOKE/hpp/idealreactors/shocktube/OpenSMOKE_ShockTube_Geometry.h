...
#ifndef OPENSMOKE_SHOCKTUBE_GEOMETRY_H
#define OPENSMOKE_SHOCKTUBE_GEOMETRY_H

#include "BzzMath.hpp"
#include "basic/OpenSMOKE_Utilities.h"
#include "idealreactors/OpenSMOKE_UD_Profile.h"

class OpenSMOKE_ShockTube_Geometry
{
public:

    OpenSMOKE_ShockTube_Geometry();

    void Setup(const std::string fileName);
	void Setup(const std::string fileName, const std::string name);
...
#endif // OPENSMOKE_SHOCKTUBE_GEOMETRY_H
