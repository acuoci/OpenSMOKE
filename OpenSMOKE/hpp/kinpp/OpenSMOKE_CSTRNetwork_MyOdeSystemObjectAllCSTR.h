...
#ifndef OPENSMOKE_CSTRNETWORK_MYODESYSTEMOBJECTALLCSTR_H
#define OPENSMOKE_CSTRNETWORK_MYODESYSTEMOBJECTALLCSTR_H

#include "BzzMath.hpp"

class OpenSMOKE_CSTRNetwork;

class OpenSMOKE_CSTRNetwork_MyOdeSystemObjectAllCSTR : public BzzOdeSystemObject
{
private:
	int numComponents;
