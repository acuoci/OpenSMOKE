...
#ifndef OPENSMOKE_POSTPROCESSOR_CSTR
#define OPENSMOKE_POSTPROCESSOR_CSTR

#include "addons/OpenSMOKE_PostProcessor_General.h"

class OpenSMOKE_PostProcessor; 

class OpenSMOKE_PostProcessor_CSTR : public OpenSMOKE_PostProcessor_General
{
public:

	OpenSMOKE_PostProcessor_CSTR(OpenSMOKE_PostProcessor *post_processor_);
...
#endif // OPENSMOKE_POSTPROCESSOR_CSTR
