...
#ifndef OPENSMOKE_POSTPROCESSOR_SHOCKTUBE
#define OPENSMOKE_POSTPROCESSOR_SHOCKTUBE

#include "addons/OpenSMOKE_PostProcessor_General.h"

class OpenSMOKE_PostProcessor; 

class OpenSMOKE_PostProcessor_ShockTube : public OpenSMOKE_PostProcessor_General
{
public:

	OpenSMOKE_PostProcessor_ShockTube(OpenSMOKE_PostProcessor *post_processor_);
...
#endif // OPENSMOKE_POSTPROCESSOR_SHOCKTUBE
