...
#ifndef OPENSMOKE_POSTPROCESSOR_ICEM_MULTIZONE
#define OPENSMOKE_POSTPROCESSOR_ICEM_MULTIZONE

#include "addons/OpenSMOKE_PostProcessor_General.h"

class OpenSMOKE_PostProcessor; 

class OpenSMOKE_PostProcessor_ICEM_MultiZone : public OpenSMOKE_PostProcessor_General
{
public:

	OpenSMOKE_PostProcessor_ICEM_MultiZone(OpenSMOKE_PostProcessor *post_processor_);
...
#endif // OPENSMOKE_POSTPROCESSOR_ICEM_MULTIZONE
