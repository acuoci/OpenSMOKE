...
#ifndef OPENSMOKE_POSTPROCESSOR_BATCH
#define OPENSMOKE_POSTPROCESSOR_BATCH

#include "addons/OpenSMOKE_PostProcessor_General.h"

class OpenSMOKE_PostProcessor; 

class OpenSMOKE_PostProcessor_Batch : public OpenSMOKE_PostProcessor_General
{
public:

	OpenSMOKE_PostProcessor_Batch(OpenSMOKE_PostProcessor *post_processor_);
...
#endif // OPENSMOKE_POSTPROCESSOR_Batch
