...
OpenSMOKE_GnuPlotInterface::OpenSMOKE_GnuPlotInterface()
{
    ...
    string message = "mkdir " + folderFigure;
...
OpenSMOKE_GnuPlotInterface::OpenSMOKE_GnuPlotInterface(string folderName)
{
...
void OpenSMOKE_GnuPlotInterface::setPlot(string _title, string _xlabel, string _ylabel)
{
    title = _title;
    xlabel = _xlabel;
    ylabel = _ylabel;
...
void OpenSMOKE_GnuPlotInterface::setKey(string _label_1)
{
    label[1] = _label_1;
    iSetLabel = 1;
}

void OpenSMOKE_GnuPlotInterface::setKey(string _label_1, string _label_2)
{
    label[1] = _label_1;    label[2] = _label_2;
    iSetLabel = 2;
}

void OpenSMOKE_GnuPlotInterface::setKey(string _label_1, string _label_2, string _label_3)
{
...
void OpenSMOKE_GnuPlotInterface::plot(string fileFigure, string fileData, int x1, int y1)
{
    BzzVectorInt x(1, x1);
    BzzVectorInt y(1, y1);
...
void OpenSMOKE_GnuPlotInterface::plot(string fileFigure, string fileData, int x1, int y1, int x2, int y2)
{
...
void OpenSMOKE_GnuPlotInterface::plot(string fileFigure, string fileData, int x1, int y1, int x2, int y2, int x3, int y3)
{
...
void OpenSMOKE_GnuPlotInterface::plot(string fileFigure, string fileData, int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4)
{
...
void OpenSMOKE_GnuPlotInterface::plot(string fileFigure, string fileData, int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4, int x5, int y5)
{
...
void OpenSMOKE_GnuPlotInterface::plot(string fileFigure, string fileData, BzzVectorInt &x, BzzVectorInt &y)
{
    int i;

    string message_a = "set output \"";
...
void OpenSMOKE_GnuPlotInterface::plot(string fileFigure, string fileData_1, string fileData_2, int x, int y)
{
    string message_a = "set output \"";
    message_a += folderFigure + "/" + fileFigure + ".eps\"";
...
void OpenSMOKE_GnuPlotInterface::plot(string fileFigure,
                        string fileData_1, string fileData_2, string fileData_3,
                        int x, int y)
{
    string message_a = "set output '";
    message_a += folderFigure + "/" + fileFigure + ".eps'";
...
string OpenSMOKE_GnuPlotInterface::i2s(int number)
{
    stringstream a;
    a << number;
    return a.str();
...
void OpenSMOKE_GnuPlotInterface::plot(string message_a, string message_b)
{
    Gnuplot g = Gnuplot("");
