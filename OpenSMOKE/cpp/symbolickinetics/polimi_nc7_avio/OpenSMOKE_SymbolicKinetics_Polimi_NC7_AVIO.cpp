...
OpenSMOKE_SymbolicKinetics_Polimi_NC7_AVIO::OpenSMOKE_SymbolicKinetics_Polimi_NC7_AVIO()
{
	NC = 86;      
	NR = 1427;
	iAccurateJacobian = 1;
...
void OpenSMOKE_SymbolicKinetics_Polimi_NC7_AVIO::SetAccurateJacobian()		
{
	iAccurateJacobian = 1;
}

void OpenSMOKE_SymbolicKinetics_Polimi_NC7_AVIO::UnsetAccurateJacobian()	
{
	iAccurateJacobian = 0;
}

void OpenSMOKE_SymbolicKinetics_Polimi_NC7_AVIO::assignKineticConstants(BzzVector &xxxk, BzzVector &xxxuK, BzzVector &xxxlogFcent, BzzVector &xxxkFallOff) 
{
	k1	= xxxk[1]; 
	k2	= xxxk[2]; 
	k3	= xxxk[3]; 
