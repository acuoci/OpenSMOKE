...
OpenSMOKE_SymbolicKinetics_SanDiego_AVIO::OpenSMOKE_SymbolicKinetics_SanDiego_AVIO()
{
	NC = 47;
	NR = 224;
	iAccurateJacobian = 1;
...
void OpenSMOKE_SymbolicKinetics_SanDiego_AVIO::SetAccurateJacobian()		
{
	iAccurateJacobian = 1;
}

void OpenSMOKE_SymbolicKinetics_SanDiego_AVIO::UnsetAccurateJacobian()	
{
	iAccurateJacobian = 0;
}

void OpenSMOKE_SymbolicKinetics_SanDiego_AVIO::assignKineticConstants(BzzVector &xxxk, BzzVector &xxxuK, BzzVector &xxxlogFcent, BzzVector &xxxkFallOff) 
{
	k1	= xxxk[1]; 
	k2	= xxxk[2]; 
	k3	= xxxk[3]; 
