...
OpenSMOKE_SymbolicKinetics_Polimi_H2CONOX_NoThermal_1101::OpenSMOKE_SymbolicKinetics_Polimi_H2CONOX_NoThermal_1101()
{
	NC = 32;
	NR = 178;
	iAccurateJacobian = 1;
...
void OpenSMOKE_SymbolicKinetics_Polimi_H2CONOX_NoThermal_1101::SetAccurateJacobian()		
{
	iAccurateJacobian = 1;
}

void OpenSMOKE_SymbolicKinetics_Polimi_H2CONOX_NoThermal_1101::UnsetAccurateJacobian()	
{
	iAccurateJacobian = 0;
}

void OpenSMOKE_SymbolicKinetics_Polimi_H2CONOX_NoThermal_1101::assignKineticConstants(BzzVector &xxxk, BzzVector &xxxuK, BzzVector &xxxlogFcent, BzzVector &xxxkFallOff) 
{
	k1	= xxxk[1]; 
	k2	= xxxk[2]; 
	k3	= xxxk[3]; 
