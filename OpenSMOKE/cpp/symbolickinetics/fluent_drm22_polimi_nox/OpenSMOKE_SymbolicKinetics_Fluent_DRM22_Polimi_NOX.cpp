...
OpenSMOKE_SymbolicKinetics_Fluent_DRM22_Polimi_NOX::OpenSMOKE_SymbolicKinetics_Fluent_DRM22_Polimi_NOX()
{
	NC = 35;
	NR = 155;
	iAccurateJacobian = 1;
...
void OpenSMOKE_SymbolicKinetics_Fluent_DRM22_Polimi_NOX::SetAccurateJacobian()		
{
	iAccurateJacobian = 1;
}

void OpenSMOKE_SymbolicKinetics_Fluent_DRM22_Polimi_NOX::UnsetAccurateJacobian()	
{
	iAccurateJacobian = 0;
}

void OpenSMOKE_SymbolicKinetics_Fluent_DRM22_Polimi_NOX::assignKineticConstants(BzzVector &xxxk, BzzVector &xxxuK, BzzVector &xxxlogFcent, BzzVector &xxxkFallOff) 
{
