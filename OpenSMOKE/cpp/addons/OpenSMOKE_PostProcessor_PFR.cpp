...
void OpenSMOKE_PostProcessor_PFR::ErrorMessage(const std::string message)
{
    cout << endl;
    cout << "Class:  OpenSMOKE_PostProcessor_PFR"		<< endl;
...
void OpenSMOKE_PostProcessor_PFR::WarningMessage(const std::string message)
{
    cout << endl;
    cout << "Class:  OpenSMOKE_PostProcessor_PFR"	<< endl;
    cout << "Object: "		<< name_object				<< endl;
...
OpenSMOKE_PostProcessor_PFR::OpenSMOKE_PostProcessor_PFR(OpenSMOKE_PostProcessor *post_processor_) 
: OpenSMOKE_PostProcessor_General(post_processor_)
{
}

void OpenSMOKE_PostProcessor_PFR::ReadFromBinaryFile(BzzLoad &fLoad)
{
	...
	cout << "PFR succesfully loaded..." << endl;

	Prepare();
}

void OpenSMOKE_PostProcessor_PFR::Prepare()
{
...
void OpenSMOKE_PostProcessor_PFR::ExportAvailableXAxis(vector<string> &x_available)
{
	x_available = list_of_x_available;
}	

void OpenSMOKE_PostProcessor_PFR::ExportAvailableYAxis(vector<string> &y_available)
{
	y_available = list_of_y_available;
}

void OpenSMOKE_PostProcessor_PFR::ImportSelectedAxis(int x_axis, vector<int> y_axis, BzzMatrix &xAxis, BzzMatrix &yAxis, std::string &name_x, std::string &name_y, vector<string> &names_lines)
{
