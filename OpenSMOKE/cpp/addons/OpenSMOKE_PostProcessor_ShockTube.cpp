...
void OpenSMOKE_PostProcessor_ShockTube::ErrorMessage(const std::string message)
{
    cout << endl;
    cout << "Class:  OpenSMOKE_PostProcessor_ShockTube"		<< endl;
...
void OpenSMOKE_PostProcessor_ShockTube::WarningMessage(const std::string message)
{
    cout << endl;
    cout << "Class:  OpenSMOKE_PostProcessor_ShockTube"	<< endl;
    cout << "Object: "		<< name_object				<< endl;
...
OpenSMOKE_PostProcessor_ShockTube::OpenSMOKE_PostProcessor_ShockTube(OpenSMOKE_PostProcessor *post_processor_) 
: OpenSMOKE_PostProcessor_General(post_processor_)
{
}

void OpenSMOKE_PostProcessor_ShockTube::ReadFromBinaryFile(BzzLoad &fLoad)
{
	...
	// Grid
	cout << "Reading SPACE..." << endl;
	CheckInBinaryFile(fLoad, "CSI");
	fLoad >> csi;
	...
	cout << "SHOCKTUBE succesfully loaded..." << endl;

	Prepare();
}

void OpenSMOKE_PostProcessor_ShockTube::Prepare()
{
	...
	list_of_x_labels.push_back("space [m]");
...
void OpenSMOKE_PostProcessor_ShockTube::ExportAvailableXAxis(vector<string> &x_available)
{
	x_available = list_of_x_available;
}	

void OpenSMOKE_PostProcessor_ShockTube::ExportAvailableYAxis(vector<string> &y_available)
{
	y_available = list_of_y_available;
}

void OpenSMOKE_PostProcessor_ShockTube::ImportSelectedAxis(int x_axis, vector<int> y_axis, BzzMatrix &xAxis, BzzMatrix &yAxis, std::string &name_x, std::string &name_y, vector<string> &names_lines)
{
