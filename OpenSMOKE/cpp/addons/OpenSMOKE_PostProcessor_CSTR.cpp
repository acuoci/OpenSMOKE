...
OpenSMOKE_PostProcessor_CSTR::OpenSMOKE_PostProcessor_CSTR(OpenSMOKE_PostProcessor *post_processor_) 
: OpenSMOKE_PostProcessor_General(post_processor_)
{
}

void OpenSMOKE_PostProcessor_CSTR::ReadFromBinaryFile(BzzLoad &fLoad)
{
	...
	cout << "CSTR succesfully loaded..." << endl;

	Prepare();
}

void OpenSMOKE_PostProcessor_CSTR::Prepare()
{
...
void OpenSMOKE_PostProcessor_CSTR::ExportAvailableXAxis(vector<string> &x_available)
{
	x_available = list_of_x_available;
}	

void OpenSMOKE_PostProcessor_CSTR::ExportAvailableYAxis(vector<string> &y_available)
{
