...
void OpenSMOKE_PostProcessor_ICEM_MultiZone::ErrorMessage(const string message)
{
    cout << endl;
...
void OpenSMOKE_PostProcessor_ICEM_MultiZone::WarningMessage(const string message)
{
    cout << endl;
    cout << "Class:  OpenSMOKE_PostProcessor_ICEM_MultiZone"	<< endl;
    cout << "Object: "		<< name_object				<< endl;
...
void OpenSMOKE_PostProcessor_ICEM_MultiZone::ImportSelectedAxis(int x_axis, vector<int> y_axis, BzzMatrix &xAxis, BzzMatrix &yAxis, string &name_x, string &name_y, vector<string> &names_lines)
{
