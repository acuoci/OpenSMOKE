...
public:
	...
	OpenSMOKE_KPP_ODE_Manager(BzzVector& xStarting_, void (*ptResiduals_)(BzzVector& x, Vec &f), int (*ptSolution_)(BzzVector& x, BzzVector &f, double& dt, const bool jacobianFlag), void (*ptAnalysis)(), OpenSMOKE_KPP_ReactorNetwork& network);
...
private:
	...
	//Parallel utilities
	int procrank_, nprocs_, numworkers_, MASTER, mtype, FROM_MASTER, FROM_WORKER;
