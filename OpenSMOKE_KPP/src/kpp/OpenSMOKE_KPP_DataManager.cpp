...
void OpenSMOKE_KPP_DataManager::ErrorMessage(const std::string message_)
{
    std::cout << std::endl;
    std::cout << "Class: OpenSMOKE_KPP_DataManager"	<< std::endl;
...
void OpenSMOKE_KPP_DataManager::WarningMessage(const std::string message_)
{
    std::cout << std::endl;
    std::cout << "Class:	  OpenSMOKE_KPP_DataManager"	<< std::endl;
...
dictionary_(dictionary)
{
	...
	nameOverallTimes_					= "OverallTimes.out";
	...
	massFlowRate_LisSolvingMethod_			= "bicg";
	massFlowRate_LisPreconditioner_			= "ilu";	
	massFlowRate_LisMaxIterations_			= "1000";
	massFlowRate_LisConvCriteria_			= "1e-12";
	...
	globalODE_LisSolvingMethod_			= "bicg";
	globalODE_LisPreconditioner_			= "ilu";	
	globalODE_LisMaxIterations_			= "1000";
	globalODE_LisConvCriteria_			= "1e-12";
	...
	globalNLS_LisSolvingMethod_			= "bicg";
	globalNLS_LisPreconditioner_			= "ilu";	
	globalNLS_LisMaxIterations_			= "1000";
	globalNLS_LisConvCriteria_			= "1e-12";
	...
	// Switch Criteria
	NormInfConvergence_				= 0.985;
	Norm1Convergence_				= 0.985;
	FirstLoopIterations_				= 3;
	SecondLoopIterations_				= 3;
	MinimumCSTRIterations_				= 50;
...
void OpenSMOKE_KPP_DataManager::CheckDictionary()
{
	...
	if (dictionary_.Return("#Clustering", string_value))
		AssignClustering(string_value);

        if (dictionary_.Return("#EnergyClustering", string_value))
            AssignEnergyClustering(string_value);
	...
	if (dictionary_.Return("#MassFlowRate_LisSolvingMethod", string_value))
		AssignLISMassFlowRateSolvingMethod(string_value);

	if (dictionary_.Return("#MassFlowRate_LisConvCriteria", string_value))
		AssignLISMassFlowRateConvCriteria(string_value);

	if (dictionary_.Return("#MassFlowRate_LisMaxIterations", string_value))
		AssignLISMassFlowRateMaxIterations(string_value);

	if (dictionary_.Return("#MassFlowRate_LisPreconditioner", string_value))
		AssignLISMassFlowRatePreconditioner(string_value);
	...
	if (dictionary_.Return("#FluctuatingSpecies", string_vector))
		SetFluctuatingSpecies(string_vector);
	...
	if (dictionary_.Return("#GlobalODE_LisSolvingMethod", string_value))
		AssignGlobalODE_LisSolvingMethod(string_value);

	if (dictionary_.Return("#GlobalODE_LisConvCriteria", string_value))
		AssignGlobalODE_LisConvCriteria(string_value);

	if (dictionary_.Return("#GlobalODE_LisMaxIterations", string_value))
		AssignGlobalODE_LisMaxIterations(string_value);

	if (dictionary_.Return("#GlobalODE_LisPreconditioner", string_value))
		AssignGlobalODE_LisPreconditioner(string_value);
	...
	if (dictionary_.Return("#GlobalNLS_LisSolvingMethod", string_value))
		AssignGlobalNLS_LisSolvingMethod(string_value);

	if (dictionary_.Return("#GlobalNLS_LisConvCriteria", string_value))
		AssignGlobalNLS_LisConvCriteria(string_value);

	if (dictionary_.Return("#GlobalNLS_LisMaxIterations", string_value))
		AssignGlobalNLS_LisMaxIterations(string_value);

	if (dictionary_.Return("#GlobalNLS_LisPreconditioner", string_value))
		AssignGlobalNLS_LisPreconditioner(string_value);
	...
	if (dictionary_.Return("#NormInfConvergence", double_value))
		SetNormInf_Convergence(double_value);
	if (dictionary_.Return("#Norm1Convergence", double_value))
		SetNorm1_Convergence(double_value);
	if (dictionary_.Return("#FirstLoopIterations", int_value))
		SetFirstLoop_Iterations(int_value);
	if (dictionary_.Return("#SecondLoopIterations", int_value))
		SetSecondLoop_Iterations(int_value);
	if (dictionary_.Return("#NumberOfSequenceCSTR", int_value))
		Set_CSTR_Iterations(int_value);

}

void OpenSMOKE_KPP_DataManager::AssignKinetics(const std::string folderName)
{
	nameFolderKinetics_ = folderName;
}

void OpenSMOKE_KPP_DataManager::AssignInputFolder(const std::string folderName)
{
...
void OpenSMOKE_KPP_DataManager::AssignBackupFile(const std::string fileName)
{
	iBackup_ = true;
	nameInputBackupFile_ = fileName;
}

void OpenSMOKE_KPP_DataManager::AssignClustering(const std::string option)
{
	if (option == "on")			iTraditionalLink_ = true;
	else if (option == "off")		iTraditionalLink_ = false;
	else ErrorMessage("#Clustering option: { on || off } values are available!");
}

void OpenSMOKE_KPP_DataManager::AssignEnergyClustering(const std::string option)
{
	if (option == "on")			iEnergyClustering_ = true;
	else if (option == "off")		iEnergyClustering_ = false;
	else ErrorMessage("#EnergyClustering option: { on || off } values are available!");
}

void OpenSMOKE_KPP_DataManager::AssignOutputFolder(const std::string folderName)
{
	...
	if(procrank() == 0)
	    ...
	    std::string systemCommand = "mkdir " + nameFolderOutput_;
            system(systemCommand.c_str());

	    systemCommand = "mkdir " + nameFolderOutput_ + slash + "Additional";
            system(systemCommand.c_str());
            
            systemCommand = "mkdir " + nameFolderOutput_ + slash + "Additional/Energy";
            system(systemCommand.c_str());

	    systemCommand = "mkdir " + nameFolderOutput_ + slash + "Maps";
            system(systemCommand.c_str());	    

            systemCommand = "mkdir " + nameFolderOutput_ + slash + "Maps/Mass";
            system(systemCommand.c_str());

            systemCommand = "mkdir " + nameFolderOutput_ + slash + "Maps/Mole";
            system(systemCommand.c_str());
	...
	nameOverallTimes_					= nameFolderOutput_ + "/Additional/OverallTimes.out";
...
void OpenSMOKE_KPP_DataManager::AssignReactions(const std::string option)
{
...
void OpenSMOKE_KPP_DataManager::AssignPredictorCorrector_DeferredConvection(const std::string option)
{
...
void OpenSMOKE_KPP_DataManager::AssignPredictorCorrector_AlgebraicConstraint(const std::string option)
{
...
void OpenSMOKE_KPP_DataManager::AssignSaveKineticConstants(const std::string option)
{
...
void OpenSMOKE_KPP_DataManager::AssignSequenceCSTR_UpdatingNetwork(const std::string option)
{
...
void OpenSMOKE_KPP_DataManager::AssignCorrection(const std::string correctionType)
{
...
void OpenSMOKE_KPP_DataManager::SetSingleReactor_IntegrationTime(const double value, const std::string units)
{
...
void OpenSMOKE_KPP_DataManager::AssignPredictorCorrector_InitialTimeStep(const double value, const std::string units)
{
...
void OpenSMOKE_KPP_DataManager::SetPredictorCorrector_MaxTimeStep(const double value, const std::string units)
{
...
void OpenSMOKE_KPP_DataManager::SetSequenceCSTR_VerboseStatistics(const std::string option)
{
...
void OpenSMOKE_KPP_DataManager::AssignMaps(const std::vector<std::string> speciesNames)
{
	mapsSpeciesNames_ = speciesNames;
}

void OpenSMOKE_KPP_DataManager::AssignGlobalODE_SparseLinearSolver(const std::string solverType)
{
...
void OpenSMOKE_KPP_DataManager::AssignGlobalNLS_SparseLinearSolver(const std::string solverType)
{
...
void OpenSMOKE_KPP_DataManager::AssignPredictorCorrector_SparseLinearSolver(const std::string solverType)
{
...
void OpenSMOKE_KPP_DataManager::AssignSparseLinearSolverMassFlowRate(const std::string solverType)
{
	...
	else if (solverType == "lis")		massFlowRate_SparseLinearSolver_ = KPP_SPARSESOLVER_LIS;
	else ErrorMessage("#MassFlowRate_SparseLinearSolver_ option: { pardiso || mumps || bzz || lis } values are available!");
}

void OpenSMOKE_KPP_DataManager::SetFillInReducingOrdering(const std::string fillInReducingOrdering)
{
...
void OpenSMOKE_KPP_DataManager::SetFluctuatingSpecies(const std::vector<std::string> speciesNames)
{
	fluctuatingSpecies_ = speciesNames;
}


void OpenSMOKE_KPP_DataManager::AssignKineticMaps(const std::string option)
{
...
void OpenSMOKE_KPP_DataManager::AssignSymbolicKinetics(const std::string option)
{
...
void OpenSMOKE_KPP_DataManager::SetPredictorCorrector_MultiTimeSplitting(const std::string option)
{
...
void OpenSMOKE_KPP_DataManager::SetGlobalODE_InitialTimeStep(const double value, const std::string units)
{
	globalODE_InitialTimeStep_ = OpenSMOKE_Conversions::conversion_time(value, units);
	globalODE_MaxTimeStep_ = 100;
}

void OpenSMOKE_KPP_DataManager::SetGlobalODE_MaxTimeStep(const double value, const std::string units)
{
...
void OpenSMOKE_KPP_DataManager::SetGlobalNLS_Method(const std::string solverType)
{
...
void OpenSMOKE_KPP_DataManager::SetNormInf_Convergence(const double value)
{
	NormInfConvergence_ = value;
}

void OpenSMOKE_KPP_DataManager::SetNorm1_Convergence(const double value)
{
	Norm1Convergence_ = value;
}

void OpenSMOKE_KPP_DataManager::SetFirstLoop_Iterations(const int value)
{
	FirstLoopIterations_ = value;
}

void OpenSMOKE_KPP_DataManager::SetSecondLoop_Iterations(const int value)
{
	SecondLoopIterations_ = value;
}

void OpenSMOKE_KPP_DataManager::Set_CSTR_Iterations(const int value)
{
	MinimumCSTRIterations_ = value;
}

void OpenSMOKE_KPP_DataManager::AssignGlobalODE_LisSolvingMethod(const std::string option)
{
	globalODE_LisSolvingMethod_ = option;	
}

void OpenSMOKE_KPP_DataManager::AssignGlobalODE_LisPreconditioner(const std::string option)
{
	globalODE_LisPreconditioner_ = option;	
}

void OpenSMOKE_KPP_DataManager::AssignGlobalODE_LisMaxIterations(const std::string option)
{
	globalODE_LisMaxIterations_ = option;	
}

void OpenSMOKE_KPP_DataManager::AssignGlobalODE_LisConvCriteria(const std::string option)
{
	globalODE_LisConvCriteria_ = option;	
}

void OpenSMOKE_KPP_DataManager::AssignGlobalNLS_LisSolvingMethod(const std::string option)
{
	globalNLS_LisSolvingMethod_ = option;	
}

void OpenSMOKE_KPP_DataManager::AssignGlobalNLS_LisPreconditioner(const std::string option)
{
	globalNLS_LisPreconditioner_ = option;	
}

void OpenSMOKE_KPP_DataManager::AssignGlobalNLS_LisMaxIterations(const std::string option)
{
	globalNLS_LisMaxIterations_ = option;	
}

void OpenSMOKE_KPP_DataManager::AssignGlobalNLS_LisConvCriteria(const std::string option)
{
	globalNLS_LisConvCriteria_ = option;	
}

void OpenSMOKE_KPP_DataManager::AssignLISMassFlowRateSolvingMethod(const std::string option)
{
	massFlowRate_LisSolvingMethod_ = option;	
}

void OpenSMOKE_KPP_DataManager::AssignLISMassFlowRatePreconditioner(const std::string option)
{
	massFlowRate_LisPreconditioner_ = option;	
}

void OpenSMOKE_KPP_DataManager::AssignLISMassFlowRateMaxIterations(const std::string option)
{
	massFlowRate_LisMaxIterations_ = option;	
}

void OpenSMOKE_KPP_DataManager::AssignLISMassFlowRateConvCriteria(const std::string option)
{
	massFlowRate_LisConvCriteria_ = option;	
}

void OpenSMOKE_KPP_DataManager::SetMinimumTemperature(const double value, const std::string units)
{
	temperatureMin_ = OpenSMOKE_Conversions::conversion_temperature(value, units);	
}

void OpenSMOKE_KPP_DataManager::SetMaximumTemperature(const double value, const std::string units)
{
