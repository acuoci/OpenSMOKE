...
//	virtual void OpenMatrix(const int nRows, const int numberNonZeroElements) = 0;
	virtual void OpenMatrix(const int nRows, const long long int numberNonZeroElements) = 0;
...
protected:
	...
	long long int numberNonZeroElements;	// Number of non zero elements
...
protected:
	...
	void CalculateSparsityPattern(const int index, const int blockDimension, const std::vector<double*>& mConvDiffusion, const std::vector<int*>& iConvDiffusion, BzzVectorInt &indicesColumns, OpenSMOKE_KPP_ReactorNetwork& network);
	void CalculateSparsityPattern(const int index, const int blockDimension, const std::vector<double*>& mConvDiff, const std::vector<int*>& iConvDiff, LIS_INT* &indicesColumns, OpenSMOKE_KPP_ReactorNetwork& network);
